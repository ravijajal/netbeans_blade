...
public class BladeStructureScanner implements StructureScanner {
    ...
    public List<? extends StructureItem> scan(ParserResult info) {
        ...
        List<BladeParserResult.Block> blocks = new ArrayList<>();
        List<BladeStructureItem> items = new ArrayList<>();
        for (BladeParserResult.Block item : result.getBlocks()) {
        ...
        boolean isTopLevel;
        for (BladeParserResult.Block item : blocks) {
            isTopLevel = true;
            for (BladeParserResult.Block check : blocks) {
            ...
            if (isTopLevel) {
                items.add(new BladeStructureItem(result.getSnapshot(), item, blocks));
            }
        }
        return items;
    ...
    public Map<String, List<OffsetRange>> folds(ParserResult info) {
        ...
        for (BladeParserResult.Block block : result.getBlocks()) {
