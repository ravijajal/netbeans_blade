...
@LanguageRegistration(mimeType = BladeLanguage.BLADE_MIME_TYPE, useCustomEditorKit = true)
public class BladeLanguage extends DefaultLanguageConfig {

    public static final String BLADE_MIME_TYPE = "text/x-blade"; // NOI18N
    public static final String BLADE_BLOCK_MIME_TYPE = "text/x-blade-block"; // NOI18N
    public static final String BLADE_VARIABLE_MIME_TYPE = "text/x-blade-variable"; // NOI18N
