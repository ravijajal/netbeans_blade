...
import org.netbeans.modules.php.blade.editor.resolver.BladeMIMEResolver;

@Messages("BladeResolver=Blade Files")
@BladeMIMEResolver.ExtensionRegistration(
        displayName = "#BladeResolver",
        position = 125,
        extension = "blade.php",
        mimeType = BladeLanguage.BLADE_MIME_TYPE
)
@BladeMIMEResolver.Registration(
        displayName = "#BladeResolver",
        resource = "config/module-mime.xml",
        position = 1
)
@Registration(displayName = "BLADE", iconBase = "org/netbeans/modules/php/blade/resources/icon.png", mimeType = BladeLanguage.BLADE_MIME_TYPE)
...
public class BladeDataObject extends MultiDataObject {
    ...
    public BladeDataObject(FileObject pf, MultiFileLoader loader) throws IOException {
        super(pf, loader);
