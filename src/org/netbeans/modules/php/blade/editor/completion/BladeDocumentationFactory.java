...
public interface BladeDocumentationFactory {
    ...
    public abstract static class BaseDocumentationFactory implements BladeDocumentationFactory {
        ...
        public BladeDocumentation create(String elementName) {
            ...
            try {
                result = new BladeDocumentationImpl(NbBundle.getMessage(TagDocumentationFactory.class, getDocumentationKey() + elementName));
    ...
    public static final class TagDocumentationFactory extends BaseDocumentationFactory {
        ...
        private static final BladeDocumentationFactory INSTANCE = new TagDocumentationFactory();
    ...
    public static final class FilterDocumentationFactory extends BaseDocumentationFactory {
        ...
        private static final BladeDocumentationFactory INSTANCE = new FilterDocumentationFactory();
    ...
    public static final class FunctionDocumentationFactory extends BaseDocumentationFactory {
        ...
        private static final BladeDocumentationFactory INSTANCE = new FunctionDocumentationFactory();
    ...
    public static final class TestDocumentationFactory extends BaseDocumentationFactory {
        ...
        private static final BladeDocumentationFactory INSTANCE = new TestDocumentationFactory();
    ...
    public static final class OperatorDocumentationFactory extends BaseDocumentationFactory {
        ...
        private static final BladeDocumentationFactory INSTANCE = new OperatorDocumentationFactory();
