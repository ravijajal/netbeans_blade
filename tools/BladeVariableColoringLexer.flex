...
%public
%class BladeVariableColoringLexer
%type BladeVariableTokenId
...
%eofval{
        if(input.readLength() > 0) {
            ...
            return BladeVariableTokenId.T_BLADE_OTHER;
        } else {
            return null;
        }
%eofval}
...
%{
    ...
    public BladeVariableColoringLexer(LexerRestartInfo info) {
...
<YYINITIAL, ST_D_STRING, ST_S_STRING, ST_INTERPOLATION>{WHITESPACE}+ {
    return BladeVariableTokenId.T_BLADE_WHITESPACE;
}

<ST_INTERPOLATION> {
    {INTERPOLATION_START} {
        return BladeVariableTokenId.T_BLADE_INTERPOLATION_START;
    }
    {INTERPOLATION_END} {
        popState();
        return BladeVariableTokenId.T_BLADE_INTERPOLATION_END;
    }
}

<YYINITIAL, ST_INTERPOLATION> {
    {OPERATOR} {
        return BladeVariableTokenId.T_BLADE_OPERATOR;
    }
    {PUNCTUATION} {
        return BladeVariableTokenId.T_BLADE_PUNCTUATION;
    }
    {NUMBER} {
        return BladeVariableTokenId.T_BLADE_NUMBER;
    }
    {D_STRING} {
        yypushback(yylength());
    ...
    {S_STRING} {
        return BladeVariableTokenId.T_BLADE_STRING;
    }
    {NAME} {
        return BladeVariableTokenId.T_BLADE_NAME;
    }
}
